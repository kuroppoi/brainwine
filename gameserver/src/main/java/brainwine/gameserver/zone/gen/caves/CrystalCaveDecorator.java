...
public class CrystalCaveDecorator extends CaveDecorator {
    ...
    @JsonIgnore
    private final WeightedList<Integer> crystals = new WeightedList<>();
    
    @JsonProperty("crystal_chance")
    private double rate = 0.15;
    
    public CrystalCaveDecorator() {
        crystals.addEntry(580, 16);
        crystals.addEntry(582, 16);
        crystals.addEntry(581, 4);
        crystals.addEntry(583, 1);
    }
